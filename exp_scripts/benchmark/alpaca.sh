...
project_root_path="../../"
cli_path="${project_root_path}/src/benchmark_evaluation/alpaca_eval.py"
data_path="${project_root_path}/data/Alpaca_Judge/Alpaca_Judge.json"
data_gen_path="${project_root_path}/data/Alpaca_Gen/Alpaca_Gen.json"
...
output_path="${project_root_path}/exp_results/alpaca_gen/${TS}/CDT_llama2_7b_chat"
mkdir -p $output_path
